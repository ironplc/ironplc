...
Runtime errors use the `V####` format and are tracked separately from compiler and editor error codes.

- **Registry**: `compiler/vm-cli/resources/problem-codes.csv`
- **Documentation**: `docs/reference/runtime/problems/V####.rst`
- **Index**: Auto-generated by the Sphinx extension
...
Create `docs/reference/runtime/problems/V####.rst`:
...
[For V4xxx: include Example section with ST code and fix guidance]
[For V6xxx: include Solutions section with numbered steps]
[For V9xxx: explain this is an internal error and ask users to report it]
```
