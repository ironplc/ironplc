...
Falling off the end of a function body behaves as `RET_VOID` ([ADR-0044](../adrs/0044-implicit-ret-void-at-end-of-function-body.md), superseding ADR-0011). The verifier checks that point as a return site, so a body that falls off the end with a non-empty operand stack is rejected before execution.
