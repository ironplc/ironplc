...
impl From<LspTokenType> for Option<SemanticToken> {
    fn from(val: LspTokenType) -> Self {
        let token_type = match val.0.token_type {
            ...
            TokenType::LineComment => Some(COMMENT_INDEX),
            ...
            TokenType::Ampersand => Some(OPERATOR_INDEX),
            ...
            TokenType::Class => Some(KEYWORD_INDEX),
            TokenType::EndClass => Some(KEYWORD_INDEX),
            ...
            TokenType::Actions => Some(KEYWORD_INDEX),
            TokenType::EndActions => Some(KEYWORD_INDEX),
            ...
            TokenType::ExternalAnnotation => Some(KEYWORD_INDEX),
            TokenType::RefAnnotation => Some(KEYWORD_INDEX),
            TokenType::AtExternal => Some(KEYWORD_INDEX),
            TokenType::Ton => Some(KEYWORD_INDEX),
            TokenType::Tof => Some(KEYWORD_INDEX),
            TokenType::Tp => Some(KEYWORD_INDEX),
            TokenType::TimeLiteral => Some(STRING_INDEX),
            TokenType::StringWithLength => Some(KEYWORD_INDEX),
        };
