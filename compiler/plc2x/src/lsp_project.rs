...
impl From<LspTokenType> for Option<SemanticToken> {
    fn from(val: LspTokenType) -> Self {
        let token_info = match val.0 {
            ...
            TokenType::Comment((pos, _)) => (pos, Some(COMMENT_INDEX)),
            ...
            TokenType::StringLiteral((pos, _)) => (pos, Some(STRING_INDEX)),
            TokenType::Identifier((pos, _)) => (pos, Some(VARIABLE_INDEX)),
            TokenType::Integer((pos, _)) => (pos, None),
            ...
            TokenType::Location((pos, _)) => (pos, Some(OPERATOR_INDEX)),
