                ...
                Some(first) => {
                    self.diagnostics.push(
                        Diagnostic::problem(
                            ...
                            Label::span(node.type_name.position(), "Structure"),
                        )
                        .with_context_id("structure", &node.type_name)
                        .with_context_id("element", &element.name)
                        .with_secondary(Label::span(first.position(), "First use of name"))
                        .with_secondary(Label::span(element.name.position(), "Second use of name")),
                    );
                }
                None => {
