...
mod tests {
    ...
    use crate::{
        intermediate_type::IntermediateType, type_environment::TypeEnvironmentBuilder, xform_resolve_type_decl_environment::apply
    };
...
END_TYPE
        ...
        assert!(matches!(&my_string_type.representation, IntermediateType::String { max_len: Some(50) }));
    }
}
