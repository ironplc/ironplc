...
e2e_i32!(
    ...
    "PROGRAM main VAR x : DINT; y : DINT; END_VAR x := 1; CASE x OF 1: y := 10; 2: y := 20; END_CASE; END_PROGRAM",
    &[(0, 1), (1, 10)],
);

e2e_i32!(
    end_to_end_when_case_matches_second_arm_then_executes_body,
    "PROGRAM main VAR x : DINT; y : DINT; END_VAR x := 2; CASE x OF 1: y := 10; 2: y := 20; END_CASE; END_PROGRAM",
    &[(0, 2), (1, 20)],
);
...
e2e_i32!(
    ...
    "PROGRAM main VAR x : DINT; y : DINT; END_VAR x := 99; CASE x OF 1: y := 10; 2: y := 20; END_CASE; END_PROGRAM",
    &[(0, 99), (1, 0)],
);

e2e_i32!(
    end_to_end_when_case_no_match_with_else_then_executes_else,
    "PROGRAM main VAR x : DINT; y : DINT; END_VAR x := 99; CASE x OF 1: y := 10; 2: y := 20; ELSE y := 99; END_CASE; END_PROGRAM",
    &[(0, 99), (1, 99)],
);

e2e_i32!(
    end_to_end_when_case_multi_selector_then_matches_any,
    "PROGRAM main VAR x : DINT; y : DINT; END_VAR x := 3; CASE x OF 1: y := 10; 2, 3: y := 30; END_CASE; END_PROGRAM",
    &[(0, 3), (1, 30)],
);

e2e_i32!(
    end_to_end_when_case_subrange_then_matches_in_range,
    "PROGRAM main VAR x : DINT; y : DINT; END_VAR x := 3; CASE x OF 1..5: y := 50; 10: y := 100; END_CASE; END_PROGRAM",
    &[(0, 3), (1, 50)],
);
...
e2e_i32_with!(
    ...
    "PROGRAM main VAR x : DINT; y : DINT; END_VAR x := 53266; CASE x OF 16#D012: y := 1; 2#1010: y := 2; END_CASE; END_PROGRAM",
    &[(1, 1)],
);
...
e2e_i32_with!(
    ...
    opts_with_bit_string_case_labels(),
    "PROGRAM main VAR x : DINT; y : DINT; END_VAR x := 10; CASE x OF 16#D012: y := 1; 2#1010: y := 2; END_CASE; END_PROGRAM",
    &[(1, 2)],
);
...
e2e_i32_with!(
    ...
    opts_with_bit_string_case_labels(),
    "PROGRAM main VAR x : DINT; y : DINT; END_VAR y := 99; x := 1; CASE x OF 16#D012: y := 1; END_CASE; END_PROGRAM",
    &[(1, 99)],
);
