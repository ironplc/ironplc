...
e2e_i32!(
    ...
    "PROGRAM main VAR s1 : STRING := 'Hello World'; s2 : STRING := 'World'; n : INT; END_VAR n := FIND(s1, s2); END_PROGRAM",
    &[(2, 7)],
);

e2e_i32!(
    end_to_end_when_find_not_found_then_returns_zero,
    "PROGRAM main VAR s1 : STRING := 'Hello World'; s2 : STRING := 'XYZ'; n : INT; END_VAR n := FIND(s1, s2); END_PROGRAM",
    &[(2, 0)],
);

e2e_i32!(
    end_to_end_when_find_at_start_then_returns_one,
    "PROGRAM main VAR s1 : STRING := 'Hello World'; s2 : STRING := 'H'; n : INT; END_VAR n := FIND(s1, s2); END_PROGRAM",
    &[(2, 1)],
);

e2e_i32!(
    end_to_end_when_find_empty_search_then_returns_zero,
    "PROGRAM main VAR s1 : STRING := 'Hello'; s2 : STRING; n : INT; END_VAR n := FIND(s1, s2); END_PROGRAM",
    &[(2, 0)],
);

e2e_i32!(
    end_to_end_when_find_exact_match_then_returns_one,
    "PROGRAM main VAR s1 : STRING := 'abc'; s2 : STRING := 'abc'; n : INT; END_VAR n := FIND(s1, s2); END_PROGRAM",
    &[(2, 1)],
);

e2e_i32!(
    end_to_end_when_find_search_longer_than_haystack_then_returns_zero,
    "PROGRAM main VAR s1 : STRING := 'Hi'; s2 : STRING := 'Hello'; n : INT; END_VAR n := FIND(s1, s2); END_PROGRAM",
    &[(2, 0)],
);
...
e2e_i32!(
    ...
    "PROGRAM main VAR s1 : STRING := 'ABCDE'; s2 : STRING := 'DE'; n : INT; END_VAR n := FIND(s1, s2); END_PROGRAM",
    &[(2, 4)],
);
