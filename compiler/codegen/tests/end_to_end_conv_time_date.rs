...
#[rstest]
#[case::time_to_dword("t : TIME := T#5s; result : DWORD;", "TIME_TO_DWORD(t)", 5000)]
#[case::dword_to_time("dw : DWORD := 3000; result : TIME;", "DWORD_TO_TIME(dw)", 3000)]
#[case::time_to_dint("t : TIME := T#5s; result : DINT;", "TIME_TO_DINT(t)", 5000)]
#[case::time_to_int("t : TIME := T#2s; result : INT;", "TIME_TO_INT(t)", 2000)]
...
fn end_to_end_time_date_exact(#[case] vars: &str, #[case] call: &str, #[case] expected: i32) {
...
#[rstest]
#[case::date_to_dword("d : DATE := D#2024-06-15; result : DWORD;", "DATE_TO_DWORD(d)")]
#[case::date_to_udint("d : DATE := D#2024-06-15; result : UDINT;", "DATE_TO_UDINT(d)")]
#[case::dt_to_dword("d : DT := DT#2024-06-15-12:30:00; result : DWORD;", "DT_TO_DWORD(d)")]
