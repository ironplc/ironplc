...
mod tests {
    ...
    fn emitter_when_div_then_correct_bytecode() {
        ...
        assert_eq!(em.bytecode(), &[0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x33]);
    }
    ...
    fn emitter_when_mod_then_correct_bytecode() {
        ...
        assert_eq!(em.bytecode(), &[0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x34]);
    }
    ...
    fn emitter_when_neg_then_correct_bytecode() {
        ...
        assert_eq!(em.bytecode(), &[0x0C, 0x00, 0x00, 0x35]);
    }
    ...
    fn emitter_when_eq_then_correct_bytecode() {
        ...
        assert_eq!(em.bytecode(), &[0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x68]);
    }
    ...
    fn emitter_when_ne_then_correct_bytecode() {
        ...
        assert_eq!(em.bytecode(), &[0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x69]);
    }
    ...
    fn emitter_when_gt_then_correct_bytecode() {
        ...
        assert_eq!(em.bytecode(), &[0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x6C]);
    }
    ...
    fn emitter_when_load_array_then_correct_bytecode() {
        ...
        assert_eq!(
            em.bytecode(),
            &[0x00, 0x00, 0x00, 0x24, 0x03, 0x00, 0x07, 0x00]
        );
    }
    ...
    fn emitter_when_store_array_then_correct_bytecode() {
        ...
        assert_eq!(
            em.bytecode(),
            &[0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x25, 0x05, 0x00, 0x02, 0x00]
        );
    }
