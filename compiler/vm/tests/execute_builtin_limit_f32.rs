...
#[test]
fn execute_when_limit_f32_nan_input_then_nan() {
    // LIMIT(MN:=1.0, IN:=NaN, MX:=10.0) = NaN
    #[rustfmt::skip]
    let bytecode: Vec<u8> = vec![
        0x03, 0x00, 0x00,  // LOAD_CONST_F32 pool[0] (1.0)  MN
        0x03, 0x01, 0x00,  // LOAD_CONST_F32 pool[1] (NaN)  IN
        0x03, 0x02, 0x00,  // LOAD_CONST_F32 pool[2] (10.0) MX
        0xC4, 0x5A, 0x03,  // BUILTIN LIMIT_F32
        0x1A, 0x00, 0x00,  // STORE_VAR_F32 var[0]
        0xB5,              // RET_VOID
...
#[test]
fn execute_when_limit_f32_nan_bound_then_nan() {
    // LIMIT(MN:=NaN, IN:=5.0, MX:=10.0) = NaN
    #[rustfmt::skip]
    let bytecode: Vec<u8> = vec![
        0x03, 0x00, 0x00,  // LOAD_CONST_F32 pool[0] (NaN)  MN
        0x03, 0x01, 0x00,  // LOAD_CONST_F32 pool[1] (5.0)  IN
        0x03, 0x02, 0x00,  // LOAD_CONST_F32 pool[2] (10.0) MX
        0xC4, 0x5A, 0x03,  // BUILTIN LIMIT_F32
        0x1A, 0x00, 0x00,  // STORE_VAR_F32 var[0]
