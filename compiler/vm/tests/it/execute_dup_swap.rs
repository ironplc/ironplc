...
fn execute_when_dup_then_duplicates_top_value() {
    ...
    assert_eq!(crate::common::run_and_read_i32(&bytecode, 1, &[42]), 84);
}
...
fn execute_when_swap_then_reverses_top_two() {
    ...
    assert_eq!(crate::common::run_and_read_i32(&bytecode, 1, &[10, 3]), -7);
}
...
fn execute_when_dup_and_swap_combined_then_correct() {
    ...
    assert_eq!(crate::common::run_and_read_i32(&bytecode, 1, &[5, 20]), 15);
}
