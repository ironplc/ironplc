...
It exposes IronPLC's parsing, semantic analysis, code generation, and
execution capabilities as MCP tools so an AI coding agent can author,
validate, and compile IEC 61131-3 programs without invoking
:program:`ironplcc` directly.
