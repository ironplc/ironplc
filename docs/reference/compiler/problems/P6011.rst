...
library of that exact name is bundled with the compiler.
...
.. code-block:: bash
   ...
   # No library named "Tc2_Maths" is bundled (note the trailing 's')
   ironplcc check --library Tc2_Maths main.st

To fix this error:

- Check the spelling and capitalization of the library name.
- Confirm the library is one that IronPLC bundles.
