...
//      calls (posthog.capture, posthog.register, etc.) made before
//      array.js finishes loading get queued and replayed once it does.
//
// Replacing this with a plain `<script async src=".../array.js">` would
// drop events fired during page load (notably `playground_loaded`),
// because `window.posthog` would still be undefined when app.js runs.
